...
public class LogUtil {
    ...
    /**
     * 设置日志等级 例： LogUtil.setLevel(LogUtil.ALL); LogUitl.setLevel(LogUtil.VERBOSE);
     *
     * @param level
     */
